    ...
    describe('Correct email', () => {
      ...
      [
        ...
        userNameCorrectSymbols.forEach((userNameSymbols1) => {
          it(`should not return error if email is wrapped in ${whitespaceTestCase.characterName} and has ${userNameSymbols1.characterDescription} character in only part before @ character`, () => {
            // given
            const email = `${whitespaceTestCase.character}${userNameSymbols1.character}@email.em${whitespaceTestCase.character}`;
          ...
          it(`should not return error if email is wrapped in ${whitespaceTestCase.characterName} and has more than one ${userNameSymbols1.characterDescription} characters in only part before @ character`, () => {
            // given
            const email = `${whitespaceTestCase.character}${userNameSymbols1.character}${userNameSymbols1.character}@email.em${whitespaceTestCase.character}`;
          ...
          userNameCorrectSymbols.forEach((userNameSymbols2) => {
            it(`should not return error if email is wrapped in ${whitespaceTestCase.characterName} and has ${userNameSymbols1.characterDescription} character in first part and ${userNameSymbols2.characterDescription} character in second part before @ character`, () => {
              // given
              const email = `${whitespaceTestCase.character}${userNameSymbols1.character}.${userNameSymbols2.character}@email.em${whitespaceTestCase.character}`;
            ...
            it(`should not return error if email is wrapped in ${whitespaceTestCase.characterName} and has more than one ${userNameSymbols1.characterDescription} characters in first part and ${userNameSymbols2.characterDescription} character in second part before @ character`, () => {
              // given
              const email = `${whitespaceTestCase.character}${userNameSymbols1.character}${userNameSymbols1.character}.${userNameSymbols2.character}@email.em${whitespaceTestCase.character}`;
            ...
            it(`should not return error if email is wrapped in ${whitespaceTestCase.characterName} and has ${userNameSymbols1.characterDescription} character in first part and more than one ${userNameSymbols2.characterDescription} characters in second part before @ character`, () => {
              // given
              const email = `${whitespaceTestCase.character}${userNameSymbols1.character}.${userNameSymbols2.character}${userNameSymbols2.character}@email.em${whitespaceTestCase.character}`;
            ...
            it(`should not return error if email is wrapped in ${whitespaceTestCase.characterName} and has more than one ${userNameSymbols1.characterDescription} characters in first part and more than one ${userNameSymbols2.characterDescription} characters in second part before @ character`, () => {
              // given
              const email = `${whitespaceTestCase.character}${userNameSymbols1.character}${userNameSymbols1.character}.${userNameSymbols2.character}${userNameSymbols2.character}@email.em${whitespaceTestCase.character}`;
